/**
 * Studio scheduling / availability — one place to edit so hero strip, CTAs, etc. stay aligned.
 * Intentionally date-free to avoid stale month ranges across the site.
 */
